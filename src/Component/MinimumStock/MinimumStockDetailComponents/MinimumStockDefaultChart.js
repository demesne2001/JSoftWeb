...
export default function MinimumStockDefaultChart(props) {
    ...
    function setDatashowOnDivWidth() {
        setTimeout(() => {
            if (document.getElementsByClassName('detailstocktosales')[0].clientWidth < 902 && document.getElementsByClassName('detailstocktosales')[0].clientWidth > 450) {
                setDatashow(5)
            } else if (document.getElementsByClassName('detailstocktosales')[0].clientWidth <= 450) {
                setDatashow(3)
            } else {
                setDatashow(11)
            }
    ...
    if (document.getElementsByClassName('detailstocktosales')[0] !== undefined) {
        ...
        if (props.state.dropdown === "1") {
            optionMultiBar = {
                themeId: 11,
                chartId: 'MinimumStocks_MainCharts',
        ...
        optionBar = {
            themeId: localStorage.getItem("ThemeIndex"),
            charttype: 'roundbar',
            height: document.getElementsByClassName('flip-card-back')[0].clientHeight - 30,
