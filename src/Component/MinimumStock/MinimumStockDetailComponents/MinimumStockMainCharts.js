...
export default function MinimumStockMainCharts(props) {
    ...
    if (document.getElementsByClassName('detailstocktosales')[0] !== undefined) {
        ...
        optionMultiBar = {
            themeId: 11,
            chartId: 'MinimumStocks_DefaultChart',
    ...
    function handleclick(e) {
        if (e.target.id !== "myDropdownicon" + props.state.ChartMode && e.target.id !== '') {
            setflag(e.target.id)
        }
    }

    function handleonchangeCurrency() {
        document.getElementById("myDropdownicon" + props.state.ChartMode).style.display === "block" ? document.getElementById("myDropdownicon" + props.state.ChartMode).style.display = "none" : document.getElementById("myDropdownicon" + props.state.ChartMode).style.display = "block";
        const tag_array = document.getElementsByClassName('dropdown-contenticon-second-screen')

        if (tag_array !== undefined) {
            for (let i = 0; i < tag_array.length; i++) {

                if (document.getElementsByClassName('dropdown-contenticon-second-screen')[i]['id'] !== "myDropdownicon" + props.state.ChartMode) {
    ...
    function handleSorting() {
        document.getElementById("sortingmenu" + props.state.ChartMode).style.display === "block" ? document.getElementById("sortingmenu" + props.state.ChartMode).style.display = "none" : document.getElementById("sortingmenu" + props.state.ChartMode).style.display = "block";
        const tag_array = document.getElementsByClassName('dropdown-contenticon-second-screen')

        if (tag_array !== undefined) {
            for (let i = 0; i < tag_array.length; i++) {
                if (document.getElementsByClassName('dropdown-contenticon-second-screen')[i]['id'] !== "sortingmenu" + props.state.ChartMode) {
                    document.getElementsByClassName('dropdown-contenticon-second-screen')[i].style.display = 'none';
                }
            }
        }
    ...
    document.getElementById("root").addEventListener("click", function (event) {
        if (event.target.className !== 'fa-solid fa-arrow-down-short-wide sorticon minimumstocktosaleschartoption' && event.target.id !== 'icon_drop') {
            if (document.getElementById("myDropdownicon" + props.state.ChartMode) !== null) {
                document.getElementById("myDropdownicon" + props.state.ChartMode).style.display = "none"
                document.getElementById("sortingmenu" + props.state.ChartMode).style.display = "none"
            }
        }
    });
    ...
    return (
        <div class="col-xl-6 col-lg-6 col-md-12 col-12 minimumstockmain">
            <div className='graph-card'>
                ...
                <div id={"sortingmenu" + props.state.ChartMode} className="dropdown-contenticon-second-screen" onClick={handleclickSort}>
                ...
                <div className='btnicons'>
                    <div id={"myDropdownicon" + props.state.ChartMode} className="dropdown-contenticon-second-screen" onClick={handleclick}>
